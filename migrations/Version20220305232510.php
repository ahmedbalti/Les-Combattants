 ...
 */
final class Version20220305232510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse_reclamation CHANGE reclamation_id reclamation_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse_reclamation CHANGE reclamation_id reclamation_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`');
    }
}
