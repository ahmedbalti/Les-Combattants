...
class __TwigTemplate_1b417dc29a29acc017960401cbde2929ba346efca5f8d8d0f51f5738813be58b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span class=\"label ";
        // line 70
        echo ((twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 70, $this->source); })()), "messages", [], "any", false, false, false, 70))) ? ("disabled") : (""));
        echo "\">
        <span class=\"icon\">";
        // line 71
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "C:\\Les_Combattants1\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\mailer.html.twig");
    }
}
